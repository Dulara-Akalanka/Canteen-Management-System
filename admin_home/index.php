    ...
    <div class="container">
      <div class="card">
        ...
        <div class="specification">
          <div class="submit"><a href="../admin/employee/index.php">
      ...
      <div class="card">
        ...
        <div class="specification">
          <div class="submit"><a href="../admin/bill/index.php">
      ...
      <div class="card">
       ...
       <center><img style="margin-top: 25px;width: 250px; height: 200px" src="images.jpg"></center>
        <div class="specification">
          <div class="submit"><a href="../admin/item/index.php">
      ...
      <div class="card">
        ...
        <div class="specification">
          <div class="submit"><a href="../admin/supplier/index.php">
